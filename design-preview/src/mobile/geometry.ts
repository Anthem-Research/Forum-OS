...
export const galaxyTabGeometry = {
  // Full-bleed 16:10 landscape canvas for the Galaxy Tab launcher. Forum OS
  // deliberately owns the whole visible surface while lock task is active.
  device: {
    width: 1280,
    height: 800,
  },
